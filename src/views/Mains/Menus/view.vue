            ...
            <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
                ...
                <div class="s">
                    <div class="flex flex-col mb-4">
                        ...
                        <input class="border py-2 px-3 text-grey-800" type="text" name="first_name" id="first_name" v-model="product.name" value="name"  disabled>
                    </div>
                    <div class="flex flex-col mb-4">
                        <div class="flex justify-start">
                        ...
                        <input class="border py-2 px-3 text-grey-800" type="text" name="last_name" id="last_name" v-model="product.price" disabled>
                    </div>
                    ...
                    <div class="flex flex-col mb-4">
                        ...
                        <select class="border py-2 px-3 text-grey-800" v-model="product.type" disabled>
                    ...
                    <div class="flex flex-col mb-4">
                        ...
                        <textarea class="border py-2 px-3 text-grey-800" disabled v-model="product.message" name="textarea" id="textarea"></textarea>
                    </div>
