                        ...
                        <div class="mt-5">
                            <div class="form">
                                ...
                                <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                    ...
                                    <button @click="cancelButton" class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100"> Cancel </button>
