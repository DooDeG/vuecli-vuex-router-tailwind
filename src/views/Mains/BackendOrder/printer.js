...
var USER = "areolitecafe@gmail.com";//必填，飞鹅云 www.feieyun.cn后台注册的账号名
var UKEY = "d8VPJPVIHytspJHk";//必填，飞鹅云后台注册账号后生成的UKEY
...
//-----------------------以下方法实现----------------------------------
export function addprinter(snlist){
...
export function print(sn, orderInfo){
		...
		// var orderInfo;
		// orderInfo = "<CB>打印</CB><BR>";//标题字体如需居中放大,就需要用标签套上
		// orderInfo += "名称　　　　　 单价  数量 金额<BR>";
		// orderInfo += "--------------------------------<BR>";
		// orderInfo += "  　　　　　　 1.0    1   1.0<BR>";
