...
<template>
    <div class="index">
        <div>
            <nav class="bg-black border-b border-gray-50 fixed z-30 w-full">
                <div class="px-3 py-3 lg:px-5 lg:pl-3">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start">
                            ...
                            <span class="ml-5 italic font-serif font-bold text-white text-3xl self-center whitespace-nowrap">DT</span>
            ...
            <div class="flex overflow-hidden pt-16">
                <nav id="sidebar" class="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
                    <div class="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
                        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <router-link to="/mains/dashboard" class=" hover:text-blue active:border-r-4 active:border-gray-700">
                                <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                                    <svg class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                                    <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                                </svg>
                                    <span class="mx-3 italic text-lg">Dashboard</span>
                                </a>
                            </router-link>
                            ...
                            <div class="space-y-4 pt-2">
                                <router-link to="/mains/bdorder" class="hover:text-blue active:border-r-4 active:border-gray-700">
                                    <a href="" target="_blank" class="mt-5 mb-2 text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                                        <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                                            <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path>
                                        </svg>
                                        <span class="ml-3 text-lg">後台下單</span>
                                    </a>
                                ...
                                <router-link to="/mains/order" class=" hover:text-blue active:border-r-4 active:border-gray-700">
                                    ...
                                    <a href="" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                                        ...
                                        <span class="ml-3 text-lg">後台訂單</span>
                                    </a>
                                </router-link>
                            </div>
                        </div>
                    ...
                    <div @click="loginout" class="mb-10">loginout
                    </div>
                </nav>
